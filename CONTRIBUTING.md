...
The following applies to code changes to the Gincoin Core project (and related projects such as libsecp256k1), and is not to be confused with overall Dash Network Protocol consensus changes.
